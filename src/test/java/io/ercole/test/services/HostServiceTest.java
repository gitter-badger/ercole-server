...
public class HostServiceTest {
	...
	@Test
	public void updateWithWithNoDbsSKIPPED() throws ParseException {
		JSONObject json3 = new JSONObject("{\"Hostname\":\"host3\",\"Info\":{},\"Extra\":{},\"Databases\":\"\","
				+ "\"Environment\":\"\",\"Location\":\"\",\"Schemas\":\"\"}");
		
		String status3 = hostService.updateWithAgent(json3, "oracledb");

		assertEquals("skipped", status3);
	}
